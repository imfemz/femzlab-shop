...
describe('schéma socle', () => {
  it('crée les 8 tables et refuse un provider inconnu', async () => {
    ...
    expect(results.map((r) => r.name)).toEqual(['blocks', 'dms', 'identities', 'link_requests', 'purchases', 'rate_events', 'user_emails', 'users']);
